...
$PAGE->set_url('/enrol/request/enableenrollment.php', array('ue'=>$ueid, 'ifilter'=>$filter));
...
$message = get_string('enableenrollmentconfirm', 'enrol_request', array('user'=>fullname($user, true), 'course'=>format_string($course->fullname)));
$fullname = fullname($user);
$title = get_string('enableenrollment', 'enrol_request');
