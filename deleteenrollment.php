...
$PAGE->set_url('/enrol/request/deleteenrollment.php', array('ue'=>$ueid, 'ifilter'=>$filter));
...
$message = get_string('deleteenrollmentconfirm', 'enrol_request', array('user'=>fullname($user, true), 'course'=>format_string($course->fullname)));
$fullname = fullname($user);
$title = get_string('deleteenrollment', 'enrol_request');
